...
var olditem, newitem;
  if (e.target == addbtn) {
      ...
      var newindex = listbox.selectedIndex + ( e.target == upbtn ? -1 : 1 );
      olditem = listbox.removeItemAt(listbox.selectedIndex);
      newitem = newindex < listbox.getRowCount() ? listbox.insertItemAt(newindex, olditem.label) : listbox.appendItem(olditem.label);
    }
if (newitem) {
